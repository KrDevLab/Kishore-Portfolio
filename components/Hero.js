function Hero() {
  return (
    <section id="hero" className="min-h-screen flex items-center pt-24 pb-12 relative" data-name="hero" data-file="components/Hero.js">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 reveal-left">
            ...
            <div className="space-y-4">
              <h2 className="text-xl md:text-2xl text-gray-400 font-medium">Hello, I'm Kishore Ravi</h2>
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <a href="hire.html" target="_blank" rel="noopener noreferrer" className="btn-outline">
                Hire Me
              </a>
            </div>
            ...
            <div className="flex items-center gap-6 pt-4">
              ...
              <a href="https://www.linkedin.com/in/kishore-ravi-/" target="_blank" className="w-10 h-10 rounded-full glass-card flex items-center justify-center text-gray-400 hover:text-white hover:scale-110 transition-all">
                <div className="icon-linkedin text-xl"></div>
              </a>
              {/* ADD YOUR GITHUB PROFILE LINK HERE */}
              <a href="https://github.com/KrDevLab" target="_blank"   className="w-10 h-10 rounded-full glass-card flex items-center justify-center text-gray-400 hover:text-white hover:scale-110 transition-all">
                <div className="icon-github text-xl"></div>
              </a>
              {/* ADD YOUR DRIBBBLE PROFILE LINK HERE */}
              <a href="#" target="_blank"  className="w-10 h-10 rounded-full glass-card flex items-center justify-center text-gray-400 hover:text-white hover:scale-110 transition-all">
